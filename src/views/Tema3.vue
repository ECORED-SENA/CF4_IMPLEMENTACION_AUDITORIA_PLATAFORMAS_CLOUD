...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.my-5 De manera general, se abordará cada uno de los dominios antes mencionados:
    .row.my-5
      .col-xl-6.fondo18
        p.mb-0.text-center.text-white.py-3 Dominio 1. Conceptos y arquitecturas de la computación en la nube.

    p.mb-5 En este dominio, se describe y define la computación en la nube, se referencia una terminología básica, y se detalla la lógica general y el marco arquitectónico utilizados en el resto del documento. (ISMS Forum, 2021)
    ...
    .row.my-5
      .col-xl-6.fondo18
        p.mb-0.text-center.text-white.py-3 Dominio 3. Cuestiones legales, contratos y descubrimiento electrónico.
    ...
    p.my-5 Algunos temas adicionales, específicos de la nube, a los se debe prestar especial atención, se pueden ver a continuación:
    ...
    .row.mt-5
      .col-xl-5.fondo18
        p.mb-0.text-center.text-white.py-3 Dominio 6. Plano de gestión y continuidad del negocio.

    .row.correr-ambos.fondo31
      .col-xl-12.p-5
        .row.justify-content-center
          .col-xl-7.col-md-10.col-sm12
        ...
        .row.justify-content-center
          .col-xl-10.col-sm-12(data-aos="slide-right")
        ...
        .row.justify-content-center.my-5
          .col-xl-8.col-md-10.col-sm-12
            ...
            img(src='@/assets/curso/tema3/botones.svg')
          .col-xl-4.col-md-6.col-sm-8
            img(src='@/assets/curso/tema3/figura3.svg')
        p.my-5 La virtualización agrega dos nuevas capas a los controles de seguridad:
        .titulo-sexto.color-acento-contenido.mb-5(data-aos="flip-right")
          h5 Figura 10
          span <i>Capas de control en la virtualización</i>
        .row.justify-content-center
          .col-xl-9.col-md-10.col-sm-10
    ...
    .row.correr-ambos.fondo31
      .col-xl-12.p-5
        ...
        .row.justify-content-center.my-5
          ...
          .col-xl-4.col-md-6.col-sm-8.col-8
            img(src='@/assets/curso/tema3/figura4.svg')
        p.my-5 Las siguientes son algunas de las recomendaciones que propone el dominio:
    ...
    .row.correr-ambos.fondo31
      .col-xl-12.p-5
        ...
        .row.justify-content-center.my-5
          ...
          .col-xl-6.col-md-4.col-sm-8.col-6
            img.mb-5.ms-5(src='@/assets/curso/tema3/figura12.png')
        .titulo-sexto.color-acento-contenido.mb-5(data-aos="flip-right")
          h5 Figura 13
          span <i>Recomendaciones para el cumplimiento de seguridad y cifrado de datos.</i> 
        .row.justify-content-center
          .col-xl-10.col-12
            img.mb-5.ms-5(src='@/assets/curso/tema3/grafica9.svg')
        ...
        .row.justify-content-center.my-5
          ...
          .col-xl-5.col-md-6.col-sm-6.col-6
